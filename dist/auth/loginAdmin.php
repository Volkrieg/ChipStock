        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6 px-0 d-none d-sm-block">
                    <img src="./img/img1.jpg" alt="Login image" class="w-100 vh-100" style="object-fit: cover; object-position: left;">
                </div>
    ...
    while ($columna = $orden->fetch_assoc()) {
        ...
        if (!empty($_POST['pass'])) {
            ...
            if (password_verify($_POST['pass'], $columna['pass'])) {
                ...
                //header("location:http://localhost/workspace-ES/TiendaAMC/panelAdmin.php");
